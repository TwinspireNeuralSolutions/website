...
/**
 * useAdminLogin — handles email/password and OAuth login logic with rate limiting.
 * Route-specific redirect logic lives in the page component.
 */
export function useAdminLogin() {
  ...
  const handleEmailLogin = useCallback(
    async (e: React.FormEvent) => {
      ...
      if (!validateInputs(sanitizedEmail, sanitizedPassword)) return
