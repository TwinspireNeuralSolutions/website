...
function HeroAthletes() {
  return (
    <section className="bg-background relative flex min-h-[85svh] items-center justify-center px-6 pt-36 pb-20 text-center">
      <div className="relative mx-auto max-w-3xl">
        <p className="text-primary mb-6 text-[11px] font-semibold tracking-widest uppercase">
          For athletes
        </p>
        <h1 className="text-foreground mb-6 font-['Barlow_Condensed',sans-serif] text-[clamp(48px,8vw,96px)] leading-none font-black tracking-tight">
          Your data.
          <br />
          Your baseline.
          <br />
          ...
          <div className="grid gap-4">
            {[
              ...
              >
                ...
                <div>
                  <p className="text-foreground mb-1 text-[15px] font-semibold">
                    {title}
                  </p>
                  <p className="text-foreground/80 text-[15px] leading-relaxed">
                    {desc}
        ...
        <div className="grid items-center gap-12 lg:grid-cols-[1fr_auto]">
          ...
          <div className="grid gap-6 sm:grid-cols-1">
            {[
              ...
              <div
                key={s.step}
                className="bg-background flex items-start gap-5 rounded-xl p-6"
              >
                <p className="text-primary/50 font-['Barlow_Condensed',sans-serif] text-[32px] leading-none font-black">
                  {s.step}
                </p>
                <div>
                  <h3 className="text-foreground mb-2 text-[16px] font-bold">
                    {s.title}
                  </h3>
                  <p className="text-foreground/80 text-[15px] leading-relaxed">
                    {s.body}
          ...
          <div className="relative mx-auto w-[250px] lg:w-[270px]">
            ...
            <div className="relative overflow-hidden rounded-[36px] border-[7px] border-[#1a1a1c] bg-[#1a1a1c] shadow-2xl">
              {/* Dynamic island */}
              <div className="absolute top-2 left-1/2 z-10 h-[18px] w-[76px] -translate-x-1/2 rounded-full bg-[#1a1a1c]" />
              {/* Screen */}
            ...
            {/* Side buttons */}
            <div className="absolute top-[110px] -left-[2px] h-[26px] w-[3px] rounded-l-sm bg-[#2a2a2c]" />
            <div className="absolute top-[150px] -left-[2px] h-[44px] w-[3px] rounded-l-sm bg-[#2a2a2c]" />
            <div className="absolute top-[205px] -left-[2px] h-[44px] w-[3px] rounded-l-sm bg-[#2a2a2c]" />
            <div className="absolute top-[160px] -right-[2px] h-[64px] w-[3px] rounded-r-sm bg-[#2a2a2c]" />
          </div>
        </div>
      </div>
    </section>
      ...
      <div className="mx-auto max-w-lg px-6 text-center">
        {status === 'success' ? (
          <>
            ...
            <h2 className="text-foreground mb-3 text-2xl font-black">
              You are on the list
            </h2>
            <p className="text-foreground/80 text-[15px] leading-relaxed">
              We will send you one email when athlete access opens. Check your
          ...
          <>
            ...
            <p className="text-foreground/80 mb-10 text-[15px] leading-relaxed">
              Twinspire is currently deploying with founding partner clubs.
              Leave your email and we will reach out when athlete access opens.
            </p>
            <div className="flex gap-3">
              <input
                ...
                className="bg-background border-border text-foreground placeholder:text-foreground/40 focus:border-primary/50 flex-1 rounded-[6px] border px-4 py-3 text-[15px] focus:outline-none"
              />
              <button
                onClick={submit}
            ...
            {status === 'error' && (
              <p className="mt-3 text-[15px] text-red-500">
                Something went wrong. Try again or email info@twinspire.ai
              </p>
            )}
            <p className="text-foreground/50 mt-4 text-[12px]">
