  ...
  try {
    ...
    await resend.emails.send({
      ...
      html: emailShell({
        ...
        body:
          p(
            'Twinspire is currently deploying with founding partner clubs across elite sport. Athlete access opens after that.'
          ) +
          p(
            'When it does, you will get one email. Your individual baseline, your Athletic Passport, and full control over who sees your data.'
          ) +
          p('No spam in the meantime.'),
        cta: {
          label: 'Learn more',
          url: 'https://twinspire.ai/en/for-athletes',
        },
      }),
    })
