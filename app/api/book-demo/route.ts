  ...
  try {
    ...
    await resend.emails.send({
      ...
      html: emailShell({
        ...
        body:
          p(
            'We have your demo request and will be in touch within one business day to confirm a time that works for you.'
          ) +
          p(
            'The session runs about 30 minutes. We will walk through the platform with your current setup in mind, and there is time at the end for questions.'
          ) +
