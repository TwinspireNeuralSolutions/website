            ...
            >
              ...
              <div className="flex flex-col gap-1">
                ...
                <div className="hover:bg-foreground/5 flex items-center gap-3 rounded-lg px-2 py-1.5 transition-colors duration-200">
                  ...
                  <span className="text-foreground/80 text-[15px] font-medium">
                ...
                >
                  ...
                  <span className="text-foreground/80 hover:text-foreground text-[15px] font-medium transition-colors duration-200">
                    {t('contact.phone')}
                  </span>
                </a>
