...
export function BookDemoSection() {
  ...
  const inputCls =
    'w-full rounded-lg border border-white/10 bg-white/5 px-4 py-3 text-[15px] text-white placeholder:text-white/30 focus:border-primary/60 focus:outline-none focus:ring-1 focus:ring-primary/30 transition-colors'
    ...
    return (
      <section id="book-demo" className="bg-background py-24 sm:py-32">
        <div className="mx-auto max-w-lg px-6 text-center">
          <div className="bg-primary/10 border-primary/20 text-primary mx-auto mb-6 flex h-14 w-14 items-center justify-center rounded-full border">
            <CheckIcon />
          </div>
          ...
          <p className="text-foreground/80 text-[15px] leading-relaxed">
            Thanks for requesting a demo. We will reach out within one business
      ...
      <div className="mx-auto max-w-2xl px-6">
        ...
        <div className="mb-12 text-center">
          ...
          <p className="text-foreground/80 mx-auto max-w-md text-[15px] leading-relaxed">
            30 minutes. We will walk you through the platform with your setup in
            mind.
          </p>
        </div>
        ...
        <div className="space-y-4">
          ...
          <div className="grid gap-4 sm:grid-cols-2">
            <div>
              <label
                htmlFor="bd-name"
                className="mb-1.5 block text-[12px] font-medium text-white/80"
              >
                Full name *
              </label>
              <input
          ...
          <div className="grid gap-4 sm:grid-cols-2">
            <div>
              ...
              <div className="relative">
                ...
                <svg
                  className="pointer-events-none absolute top-1/2 right-3 h-4 w-4 -translate-y-1/2 text-white/30"
                  viewBox="0 0 24 24"
                  fill="none"
                  stroke="currentColor"
                  strokeWidth="2"
          ...
          <div className="grid gap-4 sm:grid-cols-2">
            ...
            <div>
              <label
                ...
                className="mb-1.5 block text-[12px] font-medium text-white/80"
              >
                GPS platform you currently use
              </label>
              <div className="relative">
                <select
                  id="bd-gps"
