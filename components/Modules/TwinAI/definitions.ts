export const twinspireDefinitions = [
  {
    ...
    description: `
      ...
      <strong>muscle activity,</strong> and <strong>fatigue,</strong> our
      platform gives physiotherapists, coaches, and medical staff a
      unified, objective view of performance and recovery.
      <br /><br />
  ...
  {
    tag: 'HOW WE USE IT AT TNS',
    title: 'The Twinspire Platform in Action',
    description: `
      ...
      <ul class="mt-6 list-disc space-y-2 pl-6">
        ...
        <li>
          <strong>Physiotherapists</strong> track objective rehab progress through digital
          twins.
        </li>
        <li>
          <strong>Athletes</strong> receive instant, gamified feedback on performance and
          readiness.
        </li>
      </ul>
      <br />
